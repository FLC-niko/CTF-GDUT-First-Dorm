...
class ChallengeTriager:
    ...
    def heuristic_triage(
        ...
        if category in {"pwn", "binary"}:
            ...
            hypotheses.append("Inspect binary protections via checksec; check for dangerous functions")
            ...
            routes.append("Cryptographic analysis (weak keys, PRNG predictability, algebraic attack)")
            hypotheses.append("Analyze key generation and mathematical structure; search for known attack patterns")
            ...
            routes.append("Web vulnerability assessment (SQLi, SSRF, XSS, deserialization, auth bypass)")
            ...
            routes.append("Forensics/Misc artifact analysis (steganography, network pcap, memory dump)")
